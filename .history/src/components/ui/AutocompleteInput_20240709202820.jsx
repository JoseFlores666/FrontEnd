...
export const AutocompleteInput = ({
    ...
    extractWordsFromItem, // Función para extraer palabras según el objeto deseado
    isTextArea = false, // Propiedad para alternar entre input y textarea, valor por defecto false
}) => {
    ...
    const handleValueChange = (value) => {
        ...
        // Filtra las palabras según el valor actual
        if (!data || !data.length) {
            setFilteredWords([]);
            setShowHistorial(null);
            return;
    ...
    return (
        <div ref={containerRef} className="default-container-class">
            <InputComponent
                className={`p-3 text-black w-full rounded-md border border-gray-400 ${isTextArea ? 'resize-none' : ''}`}
