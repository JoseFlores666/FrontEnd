export const AutocompleteInput = ({
    ...
    const handleSelectWord = (selectedWord) => {
        ...
        setTimeout(() => {
            // Ejemplo de enfoque en siguiente campo
            // Esto puede ser dinámico dependiendo del uso del componente
    ...
    const handleValueChange = (value) => {
        ...
        if (value.trim() === "") {
            ...
            // Obtener palabras de la fuente de datos (dataSource)
            const uniqueWords = dataSource.map(item => item.toLowerCase()).filter(word => word.startsWith(lastWord));
            setFilteredWords(uniqueWords.slice(0, 5));
