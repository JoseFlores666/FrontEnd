...
export const AutocompleteInput = ({
  ...
  register,
  name, // New props to get the name from react-hook-form
}) => {
  ...
  return (
    <div ref={containerRef} className="relative">
      <textarea
        ...
        value={value}
        ref={(el) => {
          console.log(`Assigning ref for index ${index}`);
          descripcionRefs.current[index] = el;
        }}
        onChange={(e) => handleValueChange(e.target.value)}
        onKeyDown={handleKeyDown}
        {...inputProps}
        {...register(name)} // Register the field name with react-hook-form
      />
