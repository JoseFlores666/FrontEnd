...
export const AutocompleteInput = ({
    ...
    isTextArea = false, // Propiedad para alternar entre input y textarea
}) => {
        ...
        <div ref={containerRef} className="default-container-class">
            <InputComponent
                className={`p-3 text-black w-full rounded-md border border-gray-400 ${
                    isTextArea ? 'p-3 text-black w-full rounded-md resize-none border border-gray-400' : '' // Ajusta la altura si es un textarea
                }`}
