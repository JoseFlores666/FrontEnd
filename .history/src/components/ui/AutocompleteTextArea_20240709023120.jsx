...
export const AutocompleteTextArea = ({
    ...
    return (
        <div ref={containerRef}>
            <input
                className="p-3 text-black w-full rounded-md border border-gray-400 focus:ring-indigo-500 focus:border-indigo-500"
            ...
            {showHistorial === index && (
                <div
                    className="absolutew-full h-24 p-3 text-black border border-gray-400 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
