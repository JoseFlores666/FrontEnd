...
const AutocompleteInput = ({
    ...
    const handleValueChange = (value) => {
        ...
        if (value.trim() === "") {
            ...
            //separa el texto en palabras cada ves que encintre un espacio y las convierte en minusculas
            const words = value.toLowerCase().split(' ');

            //toma la ultima palabra del array  para que las sugerencias se basen en la última palabra escrita por el usuario
