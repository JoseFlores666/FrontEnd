                    ...
                    <div className="p-4 space-y-5">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    className="h-10 w-2/5 rounded-md border border-input px-3 py-2 border-gray-400 bg-gray-50 text-gray-900 focus:ring-blue-500 focus:border-blue-500"
                                    id="fechaOrden"
                                    type="date"
                                    value={fechaOrden}
                            ...
                            <div className="flex flex-col md:flex-row md:items-end md:justify-end">
                                <label className="text-sm font-medium leading-none md:w-1/4" htmlFor="folioExterno">
                                    No. de folio Externo:
                                </label>
                                <input
