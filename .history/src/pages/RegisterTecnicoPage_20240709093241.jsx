...
export const RegisterTecnicoPage = () => {
  ...
  const [banderafolioInterno, setBanderaFolioInterno] = useState("");
  const [banderaLlenaFolioInterno, setBanderallenaFolioInterno] = useState("");
  ...
  }, [banderafolioInterno, getFirmas]);

  useEffect(() => {
    if (banderaLlenaFolioInterno) {
      setFolioInterno(unasoli.folio || "");
      setBanderallenaFolioInterno()
    }
  }, [banderaLlenaFolioInterno, unasoli]);
