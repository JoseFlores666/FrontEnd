...
export const RegisterTecPage2 = () => {
    ...
    const handleKeyDown = (index, event) => {
        if (event.key === "Tab") {
            ...
            setShowHistorial(null); // Si no hay palabras filtradas, ocultar historial
        }
    };
    ...
    const handleDescripcionChange = (index, value) => {
        ...
        if (lastWord.trim() !== "" && value.endsWith(" ")) {
            ...
            setShowHistorial(index); // Mostrar sugerencias cuando se escriba y deje un espacio
        } else {
            setFilteredWords([]);
            setShowHistorial(null); // Ocultar sugerencias si no hay valor o espacio al final
        }
    };
