        ...
        <div className="bg-white p-6 rounded-md shadow-md">
          ...
          <div className="grid grid-cols-3 md:grid-cols-3 gap-6 mb-4">
            <div>
              ...
              <AutocompleteInput
  index={2}
  value={data.areaSolicitante}
  onChange={(newValue) => setValue("areaSolicitante", newValue)}
  data={historialOrden}
  recentSuggestions={recentSuggestions}
  setRecentSuggestions={setRecentSuggestions}
  inputRefs={formRef}
  placeholder="Ingrese el área solicitante"
  fieldsToCheck={['soliInsumosDescripcion']} // Puedes ajustar los campos según sea necesario
  inputProps={{
    type: "text",
    maxLength: 200,
