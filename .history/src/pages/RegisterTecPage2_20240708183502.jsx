                            ...
                            <div key={item.id} className="grid grid-cols-12 gap-6 mb-4">
                                <div className="col-span-3">
                                    ...
                                    <input
                                        ...
                                        defaultValue={item.cantidad} // Asegúrate de usar defaultValue para datos iniciales
                                    />
                                ...
                                <div className="col-span-6">
                                    ...
                                    <textarea
                                        ...
                                        defaultValue={item.descripcion} // Asegúrate de usar defaultValue para datos iniciales
                                        ref={(el) => (descripcionRefs.current[index] = el)}
                                        onClick={() => toggleHistorial(index)} // Toggle del historial
                                    />
                                    {showHistorial === index && (
                                        <div
