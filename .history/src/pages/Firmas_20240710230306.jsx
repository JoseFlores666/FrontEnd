          ...
          <form onSubmit={handleSubmit(guardarDatos)} >
            <div className="grid grid-cols-2 md:grid-cols-2 gap-6 mb-8 text-center">
              <div className="mb-4 gap-8 mx-10">
                ...
                <AutocompleteInput
                  index={0} // Usamos un índice fuera del rango de items
                  value={solicitud}
                  onChange={(newValue) => setSolicitud(newValue)}
                  data={nombresFirmas}
                  recentSuggestions={recentSuggestions}
                  setRecentSuggestions={setRecentSuggestions}
                  inputRefs={refs} // Asumiendo que `descripcionRefs` es un array de refs
                  placeholder="Ingrese al representante"
                  fieldsToCheck={['autorizacion', 'revision', 'solicitud', 'validacion',]} // Campos específicos a consultar
                  inputProps={{
                    type: "text",
                    maxLength: 200,
