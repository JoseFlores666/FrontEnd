        ...
        <div className="bg-white p-6 rounded-md shadow-md">
          ...
          <div>
            ...
            <AutocompleteInput
              ...
              extractWordsFromItem={(item) => item?.solicitud?.Observacionestecnicas || ''} //ruta de los elementos de la consulta xd
