...
export const RegisterTecnicoPage = () => {
  ...
  useEffect(() => {
    ...
    traeHistorialOrden();
    console.log("Folio Interno Info:", myFolioInternoInfo); // Agrega esto
  ...
  //       await 
  //       console.log("Historial Orden:", historialOrden); // Agrega esto
  ...
  //     llenaFolio();
  //   }
  // }, [banderafolioInterno, traeHistorialOrden, traeFolioInternoInforme]);

  // useEffect(() => {
  //   if (!banderaLlenaFolioInterno && myFolioInternoInfo) {
  //     console.log("Folio Interno Info:", myFolioInternoInfo); // Agrega esto
  //     setValue("folio", myFolioInternoInfo || "");
  //     setBanderallenaFolioInterno(true);
  //   }
  // }, [banderaLlenaFolioInterno, myFolioInternoInfo]);
        ...
        <div className="bg-white p-6 rounded-md shadow-md">
          ...
          <div>
            ...
            <AutocompleteInput
              ...
              extractWordsFromItem={(item) => item?.informe?.descripcionDelServicio || ''} //ruta de los elementos de la consulta xd
              isTextArea={true}  // Aquí usas el AutocompleteInput como un textarea
              inputProps={{
                maxLength: 200,
                rows: 4,
