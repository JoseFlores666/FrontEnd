...
export const RegisterTecPage2 = () => {
    ...
    const [items, setItems] = useState([{ cantidad: "", descripcion: "", historial: [] }]); // Inicializas items con un objeto que incluye historial
    ...
    const handleSelectHistorial = (itemIndex, historialIndex) => {
        const newItems = [...items];
        newItems[itemIndex].descripcion = historialOrden[historialIndex].informe.descripcionDelServicio;
        newItems[itemIndex].historial.push(historialOrden[historialIndex].informe.descripcionDelServicio);
        setItems(newItems);
                                            ...
                                            {historialOrden.map((histItem, histIndex) => (
                                                <div key={histIndex} className="mb-2">
                                                    <span
                                                        ...
                                                        onClick={() => handleSelectHistorial(index, histIndex)}
                                                    >
