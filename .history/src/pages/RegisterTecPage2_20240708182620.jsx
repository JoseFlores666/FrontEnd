                            ...
                            <div key={index} className="grid grid-cols-12 gap-6 mb-4">
                                <div className="col-span-3">
                                    ...
                                    <input
                                        ...
                                        ref={(el) => register(el, { required: true })}
                                    />
                                ...
                                <div className="col-span-3 flex flex-col items-center">
                                    ...
                                    <div className="space-x-5">
                                        <button className="text-red-500 hover:text-red-700" type="button" onClick={() => eliminarItem(index)}>
                                            <FontAwesomeIcon icon={faTrashAlt} />
                                        </button>
                                        <button className="text-blue-500 hover:text-blue-700" type="button" onClick={() => duplicarItem(index)}>
