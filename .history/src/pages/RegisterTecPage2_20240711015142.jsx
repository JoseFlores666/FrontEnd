        ...
        <div className="mx-auto max-w-4xl p-4 text-black">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="slide-down">
                <div className="bg-white p-6 rounded-md shadow-md">
                    <div className="flex items-center justify-center w-full h-11 mb-6 p-3 rounded-md ">
                        <label className="text-2xl text-transform font-bold text-center text-black">
