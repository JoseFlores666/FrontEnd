    ...
    const llenaSolicitud = () => {
        try {
            if (unasoli) {
                ...
                setValue("suministros[0].cantidad", unasoli.suministros[0]?.cantidad || "");
                setValue("suministros[0].unidad", unasoli.suministros[0]?.unidad || "");
                setValue("suministros[0].descripcion", unasoli.suministros[0]?.descripcion || "");
                setValue("suministros[0].cantidadAcumulada", unasoli.suministros[0]?.cantidadAcumulada || "");
                setValue("suministros[0].cantidadEntregada", unasoli.suministros[0]?.cantidadEntregada || "");
                setValue("suministros[0].NumeroDeEntregas", unasoli.suministros[0]?.NumeroDeEntregas || "");
            }
            setLoading(false);
        } catch (error) {
                            ...
                            <div className="flex flex-wrap gap-6 mb-4">
                                <div className="flex-1 min-w-[150px]">
                                    ...
                                    <input
                                        ...
                                        name="cantidad"
                                        className="w-full p-3 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
                                        {...register("suministros[0].cantidad")}
                                    />
                                </div>
                                <div className="flex-1 min-w-[150px]">
                                    <Label
                                ...
                                <div className="flex-1 min-w-[150px]">
                                    ...
                                    <input
                                        ...
                                        name="descripcion"
                                        className="w-full p-3 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
                                        {...register("suministros[0].descripcion")}
                                    />
                                </div>
                            </div>
                            <div className="flex flex-wrap gap-6 mb-4">
                                <div className="flex-1 min-w-[150px]">
                                    ...
                                    <input
                                        ...
                                        name="cantidadAcumulada"
                                        className="w-full p-3 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
                                        {...register("suministros[0].cantidadAcumulada")}
                                    />
                                </div>
                                <div className="flex-1 min-w-[150px]">
                                    <Label
                                    ...
                                    <input
                                        ...
                                        className="w-full p-3 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
                                        {...register("suministros[0].cantidadEntregada")}
                                    />
                                </div>
                                <div className="flex-1 min-w-[150px]">
                                    <Label
                                    ...
                                    <input
                                        ...
                                        className="w-full p-3 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
                                        {...register("suministros[0].NumeroDeEntregas")}
                                    />
                                </div>
                            </div>
                        </div>
