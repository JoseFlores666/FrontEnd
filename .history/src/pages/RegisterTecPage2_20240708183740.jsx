...
export const RegisterTecPage2 = () => {
    ...
    const { historialOrden, traeHistorialOrden } = useSoli(); // Obtiene historialOrden y traeHistorialOrden desde el contexto
    ...
    useEffect(() => {
        traeHistorialOrden(); // Carga los datos iniciales del historial al montar el componente
    }, []);
    ...
    const handleSelectHistorial = (index, selectedText) => {
        ...
        newItems[index].descripcion = selectedText; // Actualiza la descripción con el texto seleccionado
        setItems(newItems);
        setShowHistorial(null); // Cierra el historial seleccionado

        // Establece el valor del input usando setValue de react-hook-form
