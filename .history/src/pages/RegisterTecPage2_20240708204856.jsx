...
export const RegisterTecPage2 = () => {
    ...
    const handleClickOutside = (event) => {
        if (descripcionRefs.current[index] && !descripcionRefs.current[index].contains(event.target) &&
            !document.querySelector('.historial-container').contains(event.target)
        ) {
                        ...
                        {items.map((item, index) => (
                            <div key={index} className="grid grid-cols-12 gap-6 mb-4">
                                ...
                                <div className="col-span-6">
                                    ...
                                    {showHistorial === index && (
                                        <div
                                            className="absolute z-10 bg-white p-3 rounded-md border border-gray-300 shadow-lg mt-2 max-h-40 overflow-y-auto historial-container"
