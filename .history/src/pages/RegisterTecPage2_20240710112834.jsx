...
export const RegisterTecPage2 = () => {
    ...
    const handleCantidadChange = (index, newValue) => {
        const newItems = [...items]; // Crear una copia del estado actual
        newItems[index].cantidad = newValue; // Actualizar la cantidad en el índice dado
        setItems(newItems); // Actualizar el estado con los nuevos items
      };
