...
export const RegisterSolicitudPage = () => {
  ...
  return (
    <div className="mx-auto max-w-5xl p-16 text-black">
      <form onSubmit={subirDatos}>
        <div className="bg-white p-6 rounded-md shadow-md">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-ce text-black">{editar ? "Actualizar Solicitud" : "Solicitud de Servicios y Bienes de Consumo Final"}</h2>
          </div>
          <div>
