                ...
                <div className="bg-white p-6 rounded-md shadow-md">
                    ...
                    <div className="p-4 md:p-6 space-y-6">
                        ...
                        <div className="border rounded-lg bg-white">
                                    ...
                                    <tbody className="[&_tr:last-child]:border-0 border-gray-400">
                                        {items.map((item, index) => (
                                            <tr key={index} className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted border-gray-400">
                                                ...
                                                <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0 border-gray-400">
                                                    <AutocompleteInput
                                                        index={index}
                                                ...
                                                <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0 text-right border-gray-400">
                                                    <button
                            ...
                            <div className="p-4 bg-white border-b border-gray-400 rounded-b-md">
                                <button
                                    onClick={agregarItem}
                                    className="inline-flex items-center border-gray-400 justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-white hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 w-full"
                                >
                                    Agregar más
                                </button>
                            </div>
