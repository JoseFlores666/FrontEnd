...
export const RegisterTecnicoPage = () => {
  ...
  const onSubmit = async (data, e) => {
    ...
    try {
      ...
      formData.append("descripcion", data.descripcion); // Adjusted to use `data.descripcion`
        ...
        <div className="bg-white p-6 rounded-md shadow-md">
          ...
          <div className="grid grid-cols-3 md:grid-cols-3 gap-6 mb-4">
            <div>
              ...
              <AutocompleteInput
                index={0}
                value={formRef.current[0]?.areasoli || ""}
            ...
            <div>
              ...
              <AutocompleteInput
                index={1}
                value={formRef.current[1]?.solicita || ""}
            ...
            <div>
              ...
              <AutocompleteInput
                index={2}
                value={formRef.current[2]?.edificio || ""}
