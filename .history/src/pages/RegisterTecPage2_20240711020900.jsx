                    ...
                    <div className="p-4 space-y-5">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="flex justify-end">
                                ...
                                <input
                                    className="flex justify-end h-10 w-2/4 rounded-md border border-input  py-2  border-gray-400 bg-gray-50  text-gray-900 focus:ring-blue-500 focus:border-blue-500 "
                                    id="folioExterno"
                                    type="number"
