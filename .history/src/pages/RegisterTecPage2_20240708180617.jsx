...
export const RegisterTecPage2 = () => {
    ...
    const handleSelectHistorial = (index, selectedText) => {
        ...
        // Encontrar el textarea correspondiente usando el ref
        const textareaRef = descripcionRefs.current[index];
        if (textareaRef) {
            textareaRef.value = selectedText; // Establecer el valor del textarea
        }
    };
