                            ...
                            <div key={index} className="grid grid-cols-12 gap-6 mb-4">
                                    ...
                                    {showHistorial === index && (
                                        ...
                                        >
                                            {item.descripcion.trim() === "" ? (
                                                ...
                                                recentSuggestions.map((word, wordIndex) => (
                                                ...
                                                <div className="text-sm text-gray-500 mt-1">No hay sugerencias recientes.</div>
                                            )}
                                        </div>
                                    )}
                                </div>
                                <div className="col-span-3 flex flex-col items-center">
                                    ...
                                    <div className="space-x-5">
                                        ...
                                        <button className="text-yellow-500 hover:text-yellow-700" onClick={(e) => duplicarItem(index, e)}>
