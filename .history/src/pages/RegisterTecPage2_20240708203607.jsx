...
export const RegisterTecPage2 = () => {
    ...
    const handleClickOutside = (event) => {
        if (
            ...
            !document.querySelector('.text-sm.cursor-pointer.py-2.px-3').contains(event.target)
        ) {
                                ...
                                <div className="col-span-6">
                                    ...
                                    {showHistorial === index && (
                                        <div
                                            ...
                                            style={{
                                                width: descripcionRefs.current[index]?.offsetWidth,

                                                padding: '10px', // Ajusta el padding para expandir el área clickeable
                                                margin: '-10px', // Ajusta el margen negativo para expandir el área clickeable
                                            }}
                                        >
