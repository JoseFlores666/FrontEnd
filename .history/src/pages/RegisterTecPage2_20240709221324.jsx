            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="bg-white p-6 rounded-md shadow-md">
                            ...
                            <div key={index} className="grid grid-cols-12 gap-6 mb-4">
                                ...
                                <div className="col-span-7">
                                    ...
                                    <AutocompleteInput
                                        ...
                                        fieldsToCheck={['informe.descripcionDelServicio', 'solicitud.Observacionestecnicas']} // Campos específicos a consultar
                                        inputProps={{
                                            type: "text",
                                            maxLength: 200,
                                            className: "w-full text-black p-3 border border-gray-400 rounded-md focus:ring-indigo-500 focus:border-indigo-500",
                    ...
                    {/* <AutocompleteInput
                        ...
                        recentSuggestions={recentSuggestions}
                        setRecentSuggestions={setRecentSuggestions}
                        descripcionRefs={descripcionRefs} // Corregido aquí
