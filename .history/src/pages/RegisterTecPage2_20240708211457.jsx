...
export const RegisterTecPage2 = () => {
    ...
    // Filtrar el historial de consultas según el término de búsqueda
    const filteredHistorial = historialOrden.filter(item =>
        item.informe.descripcionDelServicio.toLowerCase().includes(searchTerm.toLowerCase())
    );
    ...
    return (
        <div className="mx-auto max-w-6xl p-4 text-black">
            ...
            <div className="mt-4">
                <input
                    type="text"
                    placeholder="Buscar en historial de consultas"
