        ...
        return (
            <div className="flex justify-center items-center h-screen">
                <div className="text-center mt-50">
                    ...
                    <FontAwesomeIcon className="animate-spin text-gray-500 text-6xl" icon={faSpinner} />
                </div>
            </div>
        );
    }
                    ...
                    <div className="body2">
                        <div className="bg-white p-6 rounded-lg shadow-md border border-black w-full text-black">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                                ...
                                <div>
                                    <Label htmlFor="folioExterno" className="block text-sm font-medium text-gray-700 mb-1">
                                        No. de folio externo:
                                    </Label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <Label htmlFor="NumEntregas" className="block text-sm font-medium text-gray-700 mb-1">
                                        Numero De Entregas
                                    </Label>
                                    <input
                                        type="number"
