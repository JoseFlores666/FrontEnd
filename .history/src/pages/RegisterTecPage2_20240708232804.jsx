...
export const RegisterTecPage2 = () => {
    ...
    const handleDescripcionChange = (index, value) => {
        ...
        // Aquí puedes implementar la lógica para obtener las sugerencias
        // Puedes filtrar el historialOrden o usar una API de autocompletado
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="flex justify-center mt-6">
                    <button
                        type="submit"
                        disabled={!isValid}
                        className={`bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-md ${!isValid && 'opacity-50 cursor-not-allowed'}`}
                    >
                        Guardar
                    </button>
                </div>
