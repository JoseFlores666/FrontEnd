...
export const RegisterTecPage2 = () => {
    ...
    const handleSelectHistorial = (index, selectedText) => {
        ...
        setShowHistorial(null); // Cerrar el historial después de seleccionar
    };

    const handleHistorialItemClick = (index, selectedText) => {
        handleSelectHistorial(index, selectedText);
    };
                                            ...
                                            {historialOrden.map((histItem, histIndex) => (
                                                <div key={histIndex} className="mb-2">
                                                    <span
                                                        ...
                                                        onClick={() => handleHistorialItemClick(index, histItem.informe.descripcionDelServicio)}
                                                       console.log((index, histItem.informe.descripcionDelServicio)}
                                                    >
