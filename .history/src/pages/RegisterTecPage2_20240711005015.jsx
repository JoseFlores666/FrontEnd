...
const RegisterTecPage2 = () => {
    ...
    return (
        <div className="mx-auto max-w-6xl p-4 text-black  border rounded-lg bg-white md:p-8">
       

                <form onSubmit={handleSubmit(onSubmit)} className="slide-down">
                    <div className="flex items-center justify-center w-full h-11 mb-6 bg-green-500 p-3 rounded-md text-white  md:p-6">
                        <h2 className="text-2xl font-bold text-white text-center
                    ">Llenado Exclusivo para el DEP</h2>
                    </div>
                    <div className="p-4 md:p-6 space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    className="flex h-10 w-full rounded-md border border-input bg-white px-3 py-2 text-black"
                                    id="fechaOrden"
                                    type="date"
                                    value={fechaOrden}
                                ...
                                <table className="w-full caption-bottom text-sm">
                                    <thead className="[&_tr]:border-b">
                                        <tr className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                                            <th className="h-12 px-4 text-left align-middle font-medium text-black [&:has([role=checkbox])]:pr-0">
                                                Cantidad
                                            </th>
                                            <th className="h-12 px-4 text-left align-middle font-medium text-black [&:has([role=checkbox])]:pr-0">
                                                Descripción
