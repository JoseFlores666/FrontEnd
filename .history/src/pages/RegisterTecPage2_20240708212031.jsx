...
export const RegisterTecPage2 = () => {
    ...
    const handleInputChange = (e, index) => {
        ...
        const filteredSuggestions = historialOrden.filter(
            (suggestion) =>
                        ...
                        {items.map((item, index) => (
                            <div key={index} className="grid grid-cols-12 gap-6 mb-4">
                                ...
                                <div className="col-span-6">
                                    ...
                                    {showHistorial === index && suggestions.length > 0 && (
                                        <div
                                        ...
                                        >
                                            {suggestions.map((suggestion, sugIndex) => (
                                                <div key={sugIndex} className="mb-2">
                                                    <span
                                                        className="text-sm cursor-pointer block"
                                                        onClick={() => handleSelectHistorial(index, suggestion)}
                                                    >
                                                        {suggestion}
                                                    </span>
                                                </div>
