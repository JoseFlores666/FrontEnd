...
export const RegisterSolicitudPage = () => {
  ...
  useEffect(() => {
    if (editar && unasoli || duplicar && unasoli) {
      ...
      if (unasoli.proyecto) {
        setProyecto(unasoli.proyecto._id || ""); // Assuming proyecto._id is the correct identifier
        setMyProyecto_(unasoli.proyecto.nombre || "");
      }

      if (unasoli.actividades) {
        setActividad(unasoli.actividades || ""); // Assuming actividades is an array or string
        setMyActividad_(unasoli.actividades.nombre || ""); // Adjust this based on the actual structure
      }
