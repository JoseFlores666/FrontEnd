                    ...
                    <div className="p-4 md:p-6 space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    className="flex h-10 w-full rounded-md border border-input bg-gray-100 px-3 py-2 text-black"
                                    id="fechaOrden"
                                    type="date"
                                    value={fechaOrden}
                        ...
                        <div className="border rounded-lg bg-white">
                                                ...
                                                <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0">
                                                    <AutocompleteInput
                                                        ...
                                                        inputProps={{
                                                            type: "text",
                                                            maxLength: 200,
                                                            className: "w-full text-black p-3 border bg-gray-100 border-gray-400 rounded-md focus:ring-indigo-500 focus:border-indigo-500",
                                                        }}
                                                    />
                                                </td>
                            ...
                            <div className="p-4 bg-white">
                                <button
                                    onClick={agregarItem}
                                    className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-s-inherit border-input bg-white hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 w-full"
                                >
                                    Agregar más
                                </button>
                            </div>
