...
export const RegisterTecPage2 = () => {
    ...
    const handleJustificacionChange = (index, newValue) => {
        const updatedJustificaciones = [...justificaciones];
        updatedJustificaciones[index] = newValue;
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="bg-white p-6 rounded-md shadow-md">
                            ...
                            <div key={index} className="grid grid-cols-12 gap-6 mb-4">
                                <div className="col-span-3">
                                    ...
                                    <input
                                        ...
                                        {...register(`items[${index}].cantidad`, {
                                            required: true,
                                            min: 1, // Ejemplo de validación mínima
                                            pattern: {
                                                value: /^[0-9]+$/,
                                                message: "Debe ingresar solo números."
                                            }
                                        })} error={errors.items && errors.items[index]?.cantidad?.message}
                                    />
                                     {errors.items && errors.items[index]?.cantidad && <p className="text-red-500">Llena la descripcion.</p>}
                                ...
                                <div className="col-span-7">
                                    ...
                                    <AutocompleteInput
                                        ...
                                        error={errors.items && errors.items[index]?.descripcion?.message}
                                    />
                                    {errors.items && errors.items[index]?.descripcion && <p className="text-red-500">Llena la descripcion.</p>}
                                </div>
                    ...
                    <AutocompleteInput
                        ...
                        error={errors.observacion && errors.observacion.message}
                    />
                    {errors.observacion && <p className="text-red-500">Debes dejar alguna observacion.</p>}
