                    ...
                    <div className="p-4 md:p-6 space-y-6">
                        ...
                        <div className="border rounded-lg bg-white">
                                            ...
                                            <tr key={index} className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                                                ...
                                                <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0">
                                                    <AutocompleteInput
                                                        ...
                                                        inputProps={{
                                                            type: "text",
                                                            maxLength: 200,
                                                            className: "w-full text-black p-3 borde  rounded-md  bg-gray-50  text-gray-900 focus:ring-blue-500 focus:border-blue-500",
                                                ...
                                                <td className="p-4 align-middle [&:has([role=checkbox])]:pr-0 text-right">
                                                    <button
                                                        ...
                                                        className="inline-flex items-center justify-center whitespace-nowrap border-gray-400 rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-10 w-10"
                                                    >
                                                        <svg
                            ...
                            <div className="p-4 bg-white">
                                <button
                                    onClick={agregarItem}
                                    className="inline-flex items-center justify-center whitespace-nowrap bg-gray-100 rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input  hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 w-full"
                                >
                                    Agregar más
                                </button>
                            </div>
                        ...
                        <div>
                            ...
                            <AutocompleteInput
                                ...
                                inputProps={{
                                    type: "text",
                                    maxLength: 200,
                                    className: "w-full text-black p-3  border-gray-400 bg-gray-100 rounded-md focus:ring-indigo-500 focus:border-indigo-500",
                                }}
