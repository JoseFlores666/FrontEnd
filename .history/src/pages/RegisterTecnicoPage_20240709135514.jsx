...
export const RegisterTecnicoPage = () => {
  ...
  const [justificacion, setProjectsLoaded] = useState(false);
      ...
      <form ref={formRef} onSubmit={handleSubmit(onSubmit)}>
        <div className="bg-white p-6 rounded-md shadow-md">
          ...
          <div>
            ...
            <AutocompleteInput
                        index={0}  // Aunque no hay un índice en esta sección, puedes asignar 0 o cualquier número fijo
                        value={justificacion}
                        ...
                        extractWordsFromItem={(item) => item?.solicitud?.Observacionestecnicas || ''} //ruta para que busque en la consulta xd
