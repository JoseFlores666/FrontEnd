...
import { faTrash, faFileAlt, faEdit, faTruck, faTimesCircle, faMoneyCheckAlt } from "@fortawesome/free-solid-svg-icons";
              ...
              <td className="px-3 py-2 whitespace-normal break-words border text-center">
                {rejectedSolicitudes.includes(solicitud._id) ? (
                  ...
                  <>
                    ...
                    <Link
                      to={`/soli/folioExterno/${solicitud._id}?loading=true`}
                      className="text-blue-600 hover:text-blue-800 mx-2"
                    >
                      <FontAwesomeIcon icon={faFileAlt} />
                    </Link>
                    <Link
                      to={`/soli/abonar/${solicitud._id}?loading=true`}
                      // onClick={() => setSelectedId(solicitud._id)}
