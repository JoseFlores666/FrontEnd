...
export const RegisterTecPage2 = () => {
    ...
    const handleClickOutside = (event) => {
        if (
            ...
            !event.target.classList.contains('suggestions-container') // Add a class to your suggestions container
        ) {
    ...
    const handleKeyDown = (index, event) => {
        if (event.key === "Tab") {
            if (filteredWords.length > 0) {
                ...
                setShowHistorial(null); // Hide suggestions if no filtered words
            }
        }
    };
                            ...
                            <div key={index} className="grid grid-cols-12 gap-6 mb-4">
                                ...
                                <div className="col-span-6">
                                    ...
                                    {showHistorial === index && filteredWords.length > 0 && (
                                        <div
                                            className="absolute z-10 bg-white p-3 rounded-md border border-gray-300 shadow-lg mt-2 max-h-40 overflow-y-auto suggestions-container"
