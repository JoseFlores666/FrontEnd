                            ...
                            <div key={index} className="grid grid-cols-12 gap-6 mb-4">
                                ...
                                <div className="col-span-7">
                                    ...
                                    <AutocompleteInput
                                        ...
                                        {...register(`justificaciones[${index}]`, { required: true })}
                                        error={errors.justificaciones && errors.justificaciones[index]?.message}
                                    />
                                    {errors.justificaciones && <p className="text-red-500">Debes llenar todas las justificaciones.</p>}
